...
export default function WorkProcess() {
  ...
  return (
    <section id="process" className="py-24 relative overflow-hidden bg-slate-950/60">
      {/* Glow */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {workProcess.map((step, idx) => (
            <div
              key={idx}
              className="glass-card p-6 sm:p-7 rounded-[14px] relative overflow-hidden border border-slate-800/80 hover:border-brand-cyan/40 group flex flex-col justify-between transition-all duration-200"
            >
              ...
              <div>
                {/* Step Icon Badge */}
                <div className={`w-12 h-12 rounded-[10px] bg-gradient-to-br ${step.color} p-[1.5px] mb-5 shadow-md shadow-cyan-500/10`}>
              ...
              <div className="mt-6 pt-4 border-t border-slate-800/60 flex items-center justify-between text-[10px] font-mono text-slate-500 uppercase tracking-wider">
